class DerbControllerGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    record do |m|
      ...
      m.template('index.html.erb', File.join('app/views', class_path, file_name, "index.html.erb")) if actions.include?("index")
      begin
      ...
      m.template('_form.html.erb', File.join('app/views', class_path, file_name, "_form.html.erb")) if actions.include?("new") || actions.include?("edit")
      m.template('show.html.erb', File.join('app/views', class_path, file_name, "show.html.erb")) if actions.include?("show")
      m.template('edit.html.erb', File.join('app/views', class_path, file_name, "edit.html.erb")) if actions.include?("edit")
      m.template('new.html.erb', File.join('app/views', class_path, file_name, "new.html.erb")) if actions.include?("new")
